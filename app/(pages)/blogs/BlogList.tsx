  ...
  return (
    ...
    "
      ...
      "
                    ...
                    <p className="text-sm   mt-4  "> {post?.description || 'The global debate around AI, education, and technology is often framed as screens versus schools,'}</p>
      ...
      "
                    >
                      {post?.description || 'protection versus progress. In reality, nations are deciding something far deeper: who will shape the future and who will adapt to it.'}
                    </p>
