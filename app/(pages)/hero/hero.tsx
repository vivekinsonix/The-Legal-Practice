...
import { EqualApproximatelyIcon, Mail, MapPin, MessageCircle, PhoneCall } from 'lucide-react';
  ...
  return (
    <>
      ...
      <section
        ...
        className="relative flex min-h-125 md:min-h-180
      ...
      >
        ...
        <div className="relative container mx-auto px-4 lg:px-44">
          ...
          <div className="lg:flex space-y-5 flex-wrap gap-8 mx-auto w-full text-xl justify-center font-semibold text-primary-50">
            <div>
