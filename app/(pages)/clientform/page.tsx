        ...
        <div className="mx-auto container px-4 grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-linear-to-br from-primary to-primary-200 rounded-xl p-8 text-white shadow-lg">
            <form className="space-y-5">
              ...
              <TextInput placeholder="Address" required name="address" />

              <div className="grid sm:grid-cols-2 gap-4">
                <TextInput placeholder="Country" required name="First Name" />
                <TextInput type="text" placeholder="City" name="name" />
                <TextInput type="text" placeholder="Postal Code" name="Code" />
                <TextInput type="text" placeholder="Date Of Birth" name="dob" />
              </div>
              ...
              <Button onClick={handleSubmit} disabled={!data.fullName || !data.email || !data.message || !data.subject} className="bg-secondary ml-auto">
                Submit
              </Button>
            </form>
          </div>
