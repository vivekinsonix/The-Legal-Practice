...
export function get_case_studies_Ids() {
  return apiClient.get('/case-studies?populate[main][populate]=*&populate[view1][populate]=*&populate[view2][populate]=*&populate[view3][populate][image_card][populate][images][populate]=*&populate[view5][populate]=*&populate[view6][populate]=*&populate[view7][populate]=*').then((res) => res?.data?.data?.map((case_study: any) => case_study?.slug));
}
