...
A Next.js (App Router) project for the DOLCERA UI built with TypeScript and modern React patterns. This repo contains the application source under the `app/` directory and several services, components, and utilities used across the site.
