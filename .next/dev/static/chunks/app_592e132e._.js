...
"[project]/app/(pages)/blogs/detail/[id]/BlogDetailClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const BlogSkeleton = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
...
function BlogDetailClient({ initialBlog, slug, preview }) {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(!initialBlog);
    const fetchBlog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BlogDetailClient.useCallback[fetchBlog]": async ()=>{
            if (!blog) {
                setLoading(true);
                try {
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$blogService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBlogBySlug"])(slug);
                    setBlog(res || null);
                } finally{
                    setLoading(false);
                }
    ...
    }["BlogDetailClient.useCallback[fetchBlog]"], [
        slug,
        blog
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BlogDetailClient.useEffect": ()=>{
            fetchBlog();
        }
    }["BlogDetailClient.useEffect"], [
        fetchBlog
    ...
    const seoData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BlogDetailClient.useMemo[seoData]": ()=>{
            if (!blog) {
                return {
                    seoTitle: '',
                    seoDescription: '',
    ...
    /* ---------------- Center Famous Pricing Card ---------------- */ const orderedPricingCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BlogDetailClient.useMemo[orderedPricingCards]": ()=>{
            if (!blog?.pricing_cards?.length) return [];
            const cards = [
                ...blog.pricing_cards
            ];
            const famousIndex = cards.findIndex({
                "BlogDetailClient.useMemo[orderedPricingCards].famousIndex": (c)=>c?.isFamous
            }["BlogDetailClient.useMemo[orderedPricingCards].famousIndex"]);
    ...
    /* ---------------- Render Rich Content ---------------- */ const renderedContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BlogDetailClient.useMemo[renderedContent]": ()=>{
            if (!blog?.content?.length) return null;
            return blog.content.map({
                "BlogDetailClient.useMemo[renderedContent]": (block, index)=>{
                    const plainText = block.children.map({
                        "BlogDetailClient.useMemo[renderedContent].plainText": (c)=>c.text
                    }["BlogDetailClient.useMemo[renderedContent].plainText"]).join('').trim();
                    ...
                    if (block.type === 'heading') {
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeadingTag, {
                            ...
                            children: block.children.map({
                                "BlogDetailClient.useMemo[renderedContent]": (child, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: [
    ...
    /* ---------------- States ---------------- */ if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BlogSkeleton, {}, void 0, false, {
        fileName: "[project]/app/(pages)/blogs/detail/[id]/BlogDetailClient.tsx",
        lineNumber: 179,
        columnNumber: 23
    }, this);
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                blog?.video?.[0]?.url && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("video", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: orderedPricingCards.map((card, index)=>{
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: isPopular ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BlogDetailClient, "mKPfhidzv2boD5x5S1s6ehvxZAk=");
_c1 = BlogDetailClient;
var _c, _c1;
__turbopack_context__.k.register(_c, "BlogSkeleton");
__turbopack_context__.k.register(_c1, "BlogDetailClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_592e132e._.js.map