...
"[project]/app/(pages)/clientform/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ClientFormPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientFormPage.useEffect": ()=>{
            if (cachedLocations) return;
            const fetchLocations = {
                "ClientFormPage.useEffect.fetchLocations": async ()=>{
                    try {
            ...
            }["ClientFormPage.useEffect.fetchLocations"];
            fetchLocations();
        }
    }["ClientFormPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientFormPage.useEffect": ()=>{
            ...
            const fetchTeams = {
                "ClientFormPage.useEffect.fetchTeams": async ()=>{
                    try {
            ...
            }["ClientFormPage.useEffect.fetchTeams"];
            fetchTeams();
        }
    }["ClientFormPage.useEffect"], []);
    const advisors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ClientFormPage.useMemo[advisors]": ()=>{
            if (!teams?.card) return [];
            return teams.card.filter({
                "ClientFormPage.useMemo[advisors]": (c)=>c.image?.url
            }["ClientFormPage.useMemo[advisors]"]).map({
                "ClientFormPage.useMemo[advisors]": (c)=>c.image.url
            }["ClientFormPage.useMemo[advisors]"]).slice(0, 6);
        }
    }["ClientFormPage.useMemo[advisors]"], [
        teams
    ]);
    ...
    const handlechange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ClientFormPage.useCallback[handlechange]": (e)=>{
            setData({
                ...data,
                [e.target.name]: e.target.value
            });
        }
    }["ClientFormPage.useCallback[handlechange]"], [
        data
    ]);
    const validateForm = ()=>{
    ...
    const handleSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ClientFormPage.useCallback[handleSubmit]": async (e)=>{
            e.preventDefault();
    ...
    }["ClientFormPage.useCallback[handleSubmit]"], [
        data.fullName,
        data.email,
        data.subject,
        data.message,
...
//# sourceMappingURL=_769fd290._.js.map